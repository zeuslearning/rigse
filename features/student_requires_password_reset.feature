Feature: Student requires a password reset
  ...
  Background:
    ...
    Given the following students exist:
      ...
      | student_password_reset | student  | true                   |

  Scenario: Student forced to change password
    # And the student "student" has security questions set
    When I am logged in with the username student_password_reset
  ...
  Scenario: Student updates password
    ...
    And I should see "Password for student_password_reset was successfully updated."
