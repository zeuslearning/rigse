Feature: Teacher runs student jnlps
  ...
  Background:
    ...
    And the investigation "Test Investigation" is assigned to the class "class_with_no_assignment"
    And the student "student" has run the investigation "Test Investigation" in the class "class_with_no_assignment"
    And I login with username: teacher

  Scenario: Teacher runs student jnlp from Class Page
    When I run the student's investigation from the class "class_with_no_assignment"
